...
public class ReviewController {
     ...
     */
    @GetMapping("/me")
    public ResponseEntity<ApiResponse<List<ReviewResponse>>> getMyReviews(@AuthenticationPrincipal String userId) {
        List<ReviewResponse> reviews = reviewService.getMyReviews(UUID.fromString(userId));
        return ResponseEntity.ok(ApiResponse.success(reviews));
    }
