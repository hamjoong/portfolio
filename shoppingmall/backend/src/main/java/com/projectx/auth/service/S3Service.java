...
public class S3Service {
    ...
    public S3Service(@Value("${aws.s3.bucket:dummy}") String bucketName) {
    ...
    public String getPresignedUrl(String fileName) {
        if (s3Presigner == null) {
            log.warn("[S3] Presigner is not initialized. S3 feature might be disabled.");
            throw new RuntimeException("현재 이미지 업로드 기능을 사용할 수 없습니다. (S3 비활성화)");
        }
