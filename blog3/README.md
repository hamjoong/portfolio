# ✍️ Modern Dev Blog (Blog3)

React와 TypeScript를 활용한 현대적인 감각의 개발자 블로그 템플릿 프로젝트입니다. 부드러운 애니메이션과 사용자 경험에 중점을 두었습니다.
...
---
*본 프로젝트는 정적 사이트의 성능 최적화와 모던 인터랙션 구현을 목적으로 제작되었습니다.*
