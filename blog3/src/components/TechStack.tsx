...
const TechStack: React.FC = () => {
  ...
  const stack = {
    ...
    etc: [
      { name: 'GitHub', description: 'GitHub Flow, Git-flow를 활용한 체계적인 버전 관리 및 협업' },
      ...
      { name: 'AI Agent', description: 'AI LLM 기반의 자동화 및 지능형 개발 지원 (Gemini, ChatGPT, Claude 사용경험)' },
      { name: 'CI/CD', description: 'GitHub Actions, GitHub Deploy Branch, GitHub Pages를 이용한 빌드 및 배포 자동화' },
      { name: 'Vercel', description: 'Vercel을 이용한 빠른 프론트엔드 배포와 성능 최적화' },
      { name: 'Render', description: 'Render을 이용한 빠른 백엔드 배포와 성능 최적화' },
      { name: 'Supabase', description: 'Supabase을 이용한 빠른 DB연결 및 백엔드 배포와 성능 최적화' }
    ]
  };
